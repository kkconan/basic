package com.money.game.basic.component.ext.hibernate.datatype;
...
public class EncryptedAsArrayType implements UserType {
	...
	public Object nullSafeGet(ResultSet rs, String[] names, SessionImplementor session, Object owner) throws HibernateException, SQLException {
		...
		try {
			JSONArray json = JSONArray.parseArray(message);
			return json;
		} catch (Throwable e) {
			return null;
		}
